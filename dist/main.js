  ...
  _createClass(_default, [{
    ...
    value: function addCar(event) {
      ...
      fetch(this.url, options).then(function (response) {
        ...
        console.log(data); // display all cars

        _this2.sickGarageTarget.innerHTML = "";
...
_defineProperty(_default, "targets", ['sickGarage', 'brand', 'model', 'owner', 'plate']);
